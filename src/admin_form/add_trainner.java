 ...
 * @author Boss
 */
public class add_trainner extends javax.swing.JFrame {

    /**
     * Creates new form add_trainner
     */
    public add_trainner() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("เพิ่มข้อมูลผู้สอนใหม่ ( New Trainner )");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_trainner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_trainner().setVisible(true);
            }
        });
    }
